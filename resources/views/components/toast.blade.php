...
@php
    ...
    $color = [
        ...
        'info' => [
            ...
            'bg'   => 'bg-orange-100 dark:bg-orange-800 dark:text-orange-200',
        ]
    ];
...
@if ($message)
    <div id="toast-{{ $type }}" class="toast fixed bottom-5 right-5 z-[9999] flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow-sm dark:text-gray-400 dark:bg-gray-800" role="alert">
        <div class="inline-flex items-center justify-center shrink-0 w-8 h-8  {{ $color[$type]['text'] }} {{ $color[$type]['bg'] }} rounded-lg">
            {!! $icons[$type] ?? '' !!}
        </div>
